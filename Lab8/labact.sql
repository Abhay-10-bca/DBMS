...
/* 
'root@localhost', 'RVU-PC-019', '8.4.6', '2025-09-29 06:01:46'
*/
...
-- Write the SQL Statement for the above Question
select department_id, max(salary) as maximum_salary, min(salary) as minimum_salary, avg(salary) as average_salary from employees group by department_id having max(salary)>=10000;
...
-- Write the SQL Statement for the above Question
select count(*) as employee_count, year(hire_date) from employees as hired_year group by year(hire_date); 
...
-- Write the SQL Statement for the above Question
select job_id, avg(salary) as average_salary from employees group by job_id having avg(salary)>8000;
...
-- Write the SQL Statement for the above Question
select department_id, avg(commission_pct) as average_commission from employees group by department_id having avg(commission_pct) is not null;
...
-- Write the SQL Statement for the above Question
select manager_id, count(*) as employee_count from employees group by manager_id order by count(*) desc;
...
-- Write the SQL Statement for the above Question
select department_id, job_id, sum(salary) as total_salary from employees group by department_id,job_id order by department_id,sum(salary) desc;
