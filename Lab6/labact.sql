...
-- Write your code below this line along with the output 
select Salary + (Salary*0.10) as bonus_salary from employees;

select salary - (salary*.15) as taxed_salary from employees;
...
select* from departments where DepartmentID not in ('IT Department');
...
select name from employees where departmentID=1 union select hiredate from employees where hiredate=2022 OR hiredate=2023;
select name from employees where departmentID=3 union select hiredate from employees where hiredate>2020;
select* from employees where hiredate in (2023) and hiredate not in (2022);
